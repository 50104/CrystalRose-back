...
@NoArgsConstructor
@AllArgsConstructor
public class WikiModificationComparisonDto {
    ...
    private WikiDataDto originalData;
    private WikiDataDto modifiedData;
    private List<String> changedFields; // 변경된 필드명 목록
    
    @Getter
    @Builder
    @NoArgsConstructor
    @AllArgsConstructor
    public static class WikiDataDto {
        private String name;
