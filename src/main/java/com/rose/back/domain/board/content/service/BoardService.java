...
import com.rose.back.domain.board.content.repository.BoardRepository;
import com.rose.back.infra.file.ImageUploadUtil;
...
public class BoardService {
    ...
    private final ImageUploadUtil fileHandler;

    @Autowired
    public BoardService(BoardRepository boardRepository) {
        this.boardRepository = boardRepository;
        this.fileHandler = new ImageUploadUtil();
    }
